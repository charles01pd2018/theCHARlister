...
export const EXPERIENCE_LIST_CONTENT: ExperienceListContent = {
    items: [
        ...
        },
        {
            ...
            bullets: [
                'Ideated and implemented product flows for <b>Knowt AI</b> assistant to create flashcards and notes with <b>generative AI</b> through custom prompts, resulting in hundreds of paid user signups over 3 months',
